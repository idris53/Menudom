...
public class ThankyouActivity extends Activity {
    ...
    private final float DEFAULT_LABEL_X = 70;
    private final float DEFAULT_LABEL_Y = 120;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        float productImage01Height = DEFAULT_SCREEN_HEIGHT/2;
        ImageView product_image01 = new ImageView(getApplicationContext());
        product_image01.setId(View.generateViewId());
        //product_image01.setImageResource(R.mipmap.temp_thankyou_top);
        imageLoader.displayImage(
                ("drawable://"+R.mipmap.temp_thankyou_top), product_image01,
        ...
        RelativeLayout.LayoutParams lp10 = new RelativeLayout.LayoutParams((int)productImage01Width, (int)productImage01Height-(StatusBarHeight/2));
        ...
        RelativeLayout.LayoutParams lp11 = new RelativeLayout.LayoutParams((int)productImage02Width, (int)productImage02Height-(StatusBarHeight/2));
        ...
        lp3.setMargins(0, (int)(60 * heightDiff), (int)(50 * widthDiff), 0);
        ...
        RelativeLayout.LayoutParams lp5 = new RelativeLayout.LayoutParams((int)(1024 * widthDiff), (int)(150 * heightDiff));
        lp5.addRule(RelativeLayout.ALIGN_BOTTOM, background_image.getId());
        lp5.addRule(RelativeLayout.ALIGN_LEFT, label1.getId());
        lp5.addRule(RelativeLayout.ALIGN_RIGHT, background_image.getId());
        lp5.setMargins((int)(80 * widthDiff),0,(int)(150 * widthDiff),(int)(50* heightDiff));
        ...
        lp4.setMargins(0, (int)(60* heightDiff), (int)(70* widthDiff), (int)(40* heightDiff));
        ...
        label2.setText("We would like to thank you for trying our app and wish you a great experience at our " +
                "teahouse.\n\nTo make your experience better every time, we would appreciate if you can leave your " +
                "feedback on the app, please don’t hesitate to let us know if you have any.\n\nWishing you a peaceful & " +
                "joyful time at Organika!");
        ...
        float smileyWidth = 200;
        float smileyHeight = 200;

        //float smileyX = width * (((512* widthDiff)-(70* widthDiff))/DEFAULT_SCREEN_WIDTH);

        float smileyX = width * (512/DEFAULT_SCREEN_WIDTH);

        System.out.println("width - "+width);
        System.out.println("smileyX - "+smileyX);

        ImageView okaySmiley = new ImageView(getApplicationContext());
        okaySmiley.setId(View.generateViewId());
        okaySmiley.setImageResource(R.mipmap.okay_smiley);
        //okaySmiley.setScaleType(ImageView.ScaleType.FIT_XY);
        okaySmiley.setVisibility(View.INVISIBLE);
        smileyWidth = smileyWidth * widthDiff;
        smileyHeight = smileyHeight * heightDiff;

        int smileyLeft = (int) ((smileyX - (smileyWidth/(float)2))-(80* widthDiff));

        RelativeLayout.LayoutParams lp12 = new RelativeLayout.LayoutParams((int)smileyWidth, (int)smileyHeight);
        lp12.addRule(RelativeLayout.BELOW, label2.getId());
        lp12.addRule(RelativeLayout.ALIGN_LEFT, label2.getId());
        lp12.setMargins((int)(smileyLeft),(int)(60* heightDiff),0,0);
        okaySmiley.setLayoutParams(lp12);
        relativeLayout1.addView(okaySmiley);

        ImageView sadSmiley = new ImageView(getApplicationContext());
        sadSmiley.setId(View.generateViewId());
        sadSmiley.setImageResource(R.mipmap.sad_smiley);
        sadSmiley.setVisibility(View.INVISIBLE);
        RelativeLayout.LayoutParams lp13 = new RelativeLayout.LayoutParams((int)smileyWidth, (int)smileyHeight);
        lp13.addRule(RelativeLayout.BELOW, label2.getId());
        lp13.addRule(RelativeLayout.RIGHT_OF, okaySmiley.getId());
        lp13.setMargins((int)(60* widthDiff),(int)(60* heightDiff),0,0);
        sadSmiley.setLayoutParams(lp13);
        relativeLayout1.addView(sadSmiley);

        ImageView happySmiley = new ImageView(getApplicationContext());
        happySmiley.setId(View.generateViewId());
        happySmiley.setImageResource(R.mipmap.happy_smiley);
        happySmiley.setVisibility(View.INVISIBLE);
        RelativeLayout.LayoutParams lp14 = new RelativeLayout.LayoutParams((int)smileyWidth, (int)smileyHeight);
        lp14.addRule(RelativeLayout.BELOW, label2.getId());
        lp14.addRule(RelativeLayout.ALIGN_RIGHT, okaySmiley.getId());
        lp14.setMargins(0,(int)(60* heightDiff),(int)(smileyWidth+60* widthDiff),0);
        happySmiley.setLayoutParams(lp14);
        relativeLayout1.addView(happySmiley);
        //relativelayout end
